...
export const buildBikeStyleFragment = (): MapStyleFragment => ({
  sources: {
    bike_routes: {
      type: "geojson",
...
export const buildSubwayStyleFragment = ({
  servicePeriod,
}: Extract<Layer, { kind: "subway" }>): MapStyleFragment => ({
  sources: {
...
export const LAYER_DEFINITIONS: {
  ...
  streets: {
    label: "Streets",
    mapStyleFragment: buildStreetsStyleFragment,
  },
  parks: {
    label: "Parks",
  ...
  bike_lanes: {
    label: "Bike lanes",
    mapStyleFragment: buildBikeStyleFragment,
  },
  subway: {
    label: "Subway",
    mapStyleFragment: buildSubwayStyleFragment,
